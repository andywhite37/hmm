...
class LibraryConfigs {
  ...
  static function deserializeHaxelib(v:Dynamic):VNel<String, LibraryConfig> {
    return val2(Haxelib, parseProperty(v, "name", parseString, identity), parseOptionalStringProperty(v, "version"), Nel.semigroup());
  }

  static function deserializeGit(v:Dynamic):VNel<String, LibraryConfig> {
    return val4(Git, parseProperty(v, "name", parseString, identity), parseProperty(v, "url", parseString, identity), parseOptionalStringProperty(v, "ref"),
      parseOptionalStringProperty(v, "dir"), Nel.semigroup());
  }

  static function deserializeMercurial(v:Dynamic):VNel<String, LibraryConfig> {
    return val4(Mercurial, parseProperty(v, "name", parseString, identity), parseProperty(v, "url", parseString, identity),
      parseOptionalProperty(v, "ref", parseString), parseOptionalProperty(v, "dir", parseString), Nel.semigroup());
  }

  static function deserializeDev(v:Dynamic):VNel<String, LibraryConfig> {
    return val2(Dev, parseProperty(v, "name", parseString, identity), parseProperty(v, "path", parseString, identity), Nel.semigroup());
  }
