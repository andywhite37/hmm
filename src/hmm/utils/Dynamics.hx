...
// Copied in from thx.core to fix the compiler error:
// .../.haxelib-store/thx,core/0,44,0/src/thx/fp/Dynamics.hx:129: characters 39-64 : Rest arguments can only be used in static extensions.
// .../.haxelib-store/thx,core/0,44,0/src/thx/fp/Dynamics.hx:147: characters 54-79 : Rest arguments can only be used in static extensions.
class Dynamics {
  ...
  public static function parseOptionalOrElse<E, A>(v:Null<Dynamic>, f:Dynamic->VNel<E, A>, defaultValue:A):VNel<E, A> {
    return parseOptional(v, f).map(a -> a.getOrElse(defaultValue));
  }
  ...
  public static function parseOptionalPropertyOrElse<E, A>(ob:{}, name:String, f:Dynamic->VNel<E, A>, defaultValue:A):VNel<E, A> {
    return parseOptionalProperty(ob, name, f).map(a -> a.getOrElse(defaultValue));
  }
  ...
  public static function parseTuple4<Err, A, B, C, D>(v:Dynamic, fa:Dynamic->VNel<Err, A>, fb:Dynamic->VNel<Err, B>, fc:Dynamic->VNel<Err, C>,
    ...
    return if (Types.isAnonymousObject(v)) {
      val4(Tuple4.of, parseProperty(v, "_0", fa, err), parseProperty(v, "_1", fb, err), parseProperty(v, "_2", fc, err), parseProperty(v, "_3", fd, err),
        Nel.semigroup());
    } else {
  ...
  public static function parseTuple5<Err, A, B, C, D, E>(v:Dynamic, fa:Dynamic->VNel<Err, A>, fb:Dynamic->VNel<Err, B>, fc:Dynamic->VNel<Err, C>,
    ...
    return if (Types.isAnonymousObject(v)) {
      val5(Tuple5.of, parseProperty(v, "_0", fa, err), parseProperty(v, "_1", fb, err), parseProperty(v, "_2", fc, err), parseProperty(v, "_3", fd, err),
        parseProperty(v, "_4", fe, err), Nel.semigroup());
    } else {
  ...
  public static function parseTuple6<Err, A, B, C, D, E, F>(v:Dynamic, fa:Dynamic->VNel<Err, A>, fb:Dynamic->VNel<Err, B>, fc:Dynamic->VNel<Err, C>,
    ...
    return if (Types.isAnonymousObject(v)) {
      val6(Tuple6.of, parseProperty(v, "_0", fa, err), parseProperty(v, "_1", fb, err), parseProperty(v, "_2", fc, err), parseProperty(v, "_3", fd, err),
        parseProperty(v, "_4", fe, err), parseProperty(v, "_5", ff, err), Nel.semigroup());
    } else {
